# TIPOS PRIMITIVOS - Primeiro tipo -> int()
#n1 = input('Digite um valor: ')
#print(type(n1)) 
#Quero saber o tipo primitivo de n1, por isso o 'type'. 
#Após rodar o código, foi mostrado na tela que n1 é do tipo str, ou seja string.
